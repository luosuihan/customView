...
public class DemoView05 extends View {
    ...
    public DemoView05(Context context) {
        super(context);
        initView();
    }

    public DemoView05(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public DemoView05(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
